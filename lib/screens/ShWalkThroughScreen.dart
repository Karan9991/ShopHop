          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    Text(mHeadingList[position], style: boldTextStyle(size: 24)),
                    16.height,
                    Text(
                  ...
                  (slider) {
                    return Builder(
                      builder: (BuildContext context) {
                        return Container(
                          width: width * 0.9,
                          decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(spacing_standard))),
                          margin: EdgeInsets.all(spacing_standard_new),
                          child: Image.asset(slider, width: context.width(), fit: BoxFit.cover).center(),
                        );
                      },
                    );
                  },
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Text(sh_lbl_already_have_a_account, style: primaryTextStyle(color: gray)),
