            ...
            endActionPane: ActionPane(
              ...
              children: [
                SlidableAction(
                  ...
                  icon: Icons.edit,
                  onPressed: (context) => editCard(list[index]),
                ),
                SlidableAction(
                  label: 'Delete',
                  backgroundColor: Colors.redAccent,
                  icon: Icons.delete_outline,
                  onPressed: (context) => deleteCard(list[index]),
                ),
              ],
            ),
            child: InkWell(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: <Widget>[text("Debit card", textColor: sh_white, fontSize: textSizeLargeMedium, fontFamily: fontBold), text("MVK Bank", textColor: sh_white, fontSize: textSizeLargeMedium, fontFamily: fontBold)],
                                  ),
                                  SizedBox(
